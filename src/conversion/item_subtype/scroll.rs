...
pub fn from_usize(subtype: usize) -> Option<Scroll1SubType> {
    match subtype {
        ...
        258 => Some(Scroll1SubType::EnchantWeapon),
        257 => Some(Scroll1SubType::EnchantWeaponToDam),
        257 => Some(Scroll1SubType::EnchantWeaponToHit),
        ...
        260 => Some(Scroll1SubType::Identify),
        262 => Some(Scroll1SubType::Light),
        268 => Some(Scroll1SubType::MagicMapping),
        ...
        264 => Some(Scroll1SubType::PhaseDoor),
        ...
        269 => Some(Scroll1SubType::SleepMonster),
        263 => Some(Scroll1SubType::SummonMonster),
        261 => Some(Scroll1SubType::SummonUndead),
        266 => Some(Scroll1SubType::Teleport),
        ...
        267 => Some(Scroll1SubType::Wishing),
        265 => Some(Scroll1SubType::WordOfRecall),
        _ => None,
    }
}
