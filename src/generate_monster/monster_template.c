...
monster_template const monster_templates[] = {
  ...
  // Level 1
    {6, 5, "Brown Imp", 0x00000204, 0x00000000, 0x00F6, 8, 2, 1, 'x', "3d4", "1 3 1d3", 1, 0, {.multiplies = true, .can_move = true}},
    ...
    {12, 7, "White Icky-Thing", 0x00000144, 0x00000000, 0x0022, 100, 2, 1, 'i', "3d5", "1 5 1d2", 1, 0, {.multiplies = false, .can_move = true}},
    {12, 6, "Clear Icky-Thing", 0x00010140, 0x00000000, 0x0022, 100, 1, 1, 'i', "2d5", "1 5 1d2", 1, 0, {.multiplies = false, .can_move = true}},
    {8, 4, "Giant White Mouse", 0x00000202, 0x00000000, 0x2070, 200, 1, 1, 'r', "1d3", "1 2 1d2", 1, 0, {.multiplies = true, .can_move = true}},
    ...
    {5, 5, "Leech", 0x00100210, 0x00000000, 0x0070, 1000, 2, 2, 'l', "1d1", "1 30 2d2", 1, 0, {.multiplies = true, .can_move = false}},
  // Level 2
    {6, 5, "Black Imp", 0x00000204, 0x00000000, 0x00F6, 10, 3, 1, 'x', "2d3", "6 2 1d3|1 3 1d4", 2, 0, {.multiplies = true, .can_move = true}},
    {2, 1, "Shrieker Mushroom patch", 0x00000000, 0x00000000, 0x10A0, 0, 1, 1, ',', "1d1", "20 10 0d0", 2, 0, {.multiplies = false, .can_move = false}},
    {10, 4, "Blubbering Icky-Thing", 0x0B180144, 0x00000000, 0x0022, 100, 8, 1, 'i', "5d8", "14 12 1d4|22 12 0d0", 2, 0, {.multiplies = false, .can_move = true}},
    ...
    {20, 16, "Jester", 0x07020200, 0x0000040C, 0x2070, 50, 6, 1, 'p', "7d4", "1 1 1d5|11 23 1d2", 2, 0, {.multiplies = false, .can_move = true}},
  ...
  // Level 3
    {6, 10, "Fire Imp", 0x00000208, 0x00000000, 0x00D6, 15, 4, 1, 'x', "3d3", "5 3 2d3", 3, 0, {.multiplies = true, .can_move = true}},
    ...
    {6, 5, "Giant White Lice", 0x00000148, 0x00000000, 0x01F0, 100, 1, 2, 'l', "1d1", "1 2 1d1", 3, 0, {.multiplies = true, .can_move = true}},
  ...
  // Level 4
    {6, 10, "Ice Imp", 0x00000204, 0x00000000, 0x00E6, 20, 4, 1, 'x', "5d4", "7 3 3d3", 4, 0, {.multiplies = true, .can_move = true}},
    {8, 5, "Silver Mouse", 0x00000202, 0x00000000, 0x2072, 100, 1, 1, 'r', "1d1", "23 1 1d1|1 1 1d1", 4, 0, {.multiplies = true, .can_move = true}},
  ...
  // Level 5
    ...
    {14, 12, "Grey Icky-Thing", 0x00000144, 0x00000000, 0x0022, 150, 10, 1, 'i', "4d8", "1 5 1d5", 5, 0, {.multiplies = false, .can_move = true}},
  ...
  // Level 6
    ...
    {18, 14, "Blue Icky-Thing", 0x00000144, 0x00000000, 0x0022, 200, 12, 1, 'i', "4d8", "7 5 2d3", 6, 0, {.multiplies = false, .can_move = true}},
  ...
  // Level 7
    ...
    {14, 12, "Green Icky-Thing", 0x00000144, 0x00000000, 0x0022, 200, 18, 1, 'i', "5d8", "9 5 2d5", 7, 0, {.multiplies = false, .can_move = true}},
  ...
  // Level 8
    ...
    {14, 18, "Red Icky-Thing", 0x00000144, 0x00000000, 0x0022, 200, 22, 2, 'i', "4d8", "1 5 1d3|6 8 1d5", 8, 0, {.multiplies = false, .can_move = true}},
  ...
  // Level 9
    ...
    {14, 18, "Bloodshot Icky-Thing", 0x00000142, 0x0001000B, 0x2022, 800, 24, 1, 'i', "7d8", "1 5 1d4|9 8 2d4", 9, 0, {.multiplies = false, .can_move = true}},
  ...
  // Level 10
    ...
    {6, 10, "Evil-Looking Peasant", 0x19000000, 0x00010486, 0x10F0, 50, 100, 1, 'p', "10d6", "1 1 6-2d2", 10, 0, {.multiplies = false, .can_move = true}},
  // Level 11
  ...
  // Level 14
    ...
    {6, 7, "Giant Black Lice", 0x00000244, 0x00000000, 0x01F2, 100, 1, 2, 'l', "1d1", "1 2 1d2", 14, 0, {.multiplies = true, .can_move = true}},
  // Level 15
  ...
  // Level 17
    ...
    {6, 30, "Giant Water Imp", 0x00400210, 0x00000000, 0x0002, 8, 100, 2, 'x', "12d8", "1 30 5d4|11 2 1d3", 17, 0, {.multiplies = false, .can_move = true}},
  ...
  // Level 18
    ...
    {10, 20, "Phase Imp", 0x00060300, 0x00000000, 0x8000, 110, 175, 1, 'x', "20d8", "1 3 6d6", 18, 0, {.multiplies = false, .can_move = true}},
  // Level 19
  ...
  // Level 20
    ...
    {8, 25, "Disenchanter Icky-Thing", 0x05300244, 0x0001000A, 0x1000, 500, 10, 0, 'i', "8d10", "21 12 2d2", 20, 15, {.multiplies = false, .can_move = true}},
