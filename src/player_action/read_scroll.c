...
void rs__scroll_effect(long effect, bool *idented, bool *first,
  ...
  case 3: /*{ Enchant Armor }*/
    ...
    if ((Cursed_worn_bit & equipment[Equipment_armor].flags) != 0) {
      i4 = Equipment_armor;
    } else if ((Cursed_worn_bit & equipment[Equipment_shield].flags) != 0) {
      i4 = Equipment_shield;
    } else if ((Cursed_worn_bit & equipment[Equipment_cloak].flags) != 0) {
      i4 = Equipment_cloak;
    } else if ((Cursed_worn_bit & equipment[Equipment_helm].flags) != 0) {
      i4 = Equipment_helm;
    } else if ((Cursed_worn_bit & equipment[Equipment_gloves].flags) != 0) {
      i4 = Equipment_gloves;
    } else if ((Cursed_worn_bit & equipment[Equipment_boots].flags) != 0) {
      i4 = Equipment_boots;
    } else if ((Cursed_worn_bit & equipment[Equipment_belt].flags) != 0) {
      i4 = Equipment_belt;
    } else if ((Cursed_worn_bit & equipment[Equipment_bracers].flags) != 0) {
