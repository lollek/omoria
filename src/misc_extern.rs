...
#[no_mangle]
pub extern "C" fn max_allowable_weight() -> u16 {
    misc::max_allowable_weight()
}

#[no_mangle]
pub extern "C" fn min_allowable_weight() -> u16 {
    misc::min_allowable_weight()
}

#[no_mangle]
pub extern "C" fn C_print_known_spells() {
    misc::print_known_spells();
}

// Utility function for misc.c::print_new_spells to use rust-strings
#[no_mangle]
pub extern "C" fn C_print_new_spell_line(i: u8, slot: libc::c_long, failchance: libc::c_long) {
