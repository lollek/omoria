...
treasure_type yums[NUM_YUM + 1] = {
    {Food, 0x00000000, Nothing_flag, 500, 1, 309, 2, 1,
     0, 0, 0, 0, "0d0", -1, 0},
    {Food, 0x00000000, Nothing_flag, 500, 1, 309, 2, 1, 0, 0,
     0, 0, "0d0", -1, 0},
    {Food, 0x00000000, Nothing_flag, 400, 2, 312, 10, 1,
     0, 0, 0, 0, "0d0", -1, 0},
    {Food, 0x00000000, Nothing_flag, 1750, 2, 310, 2,
     1, 0, 0, 0, 0, "0d0", -1, 0},
    {Food, 0x00000000, 0x21800020, 3500, 10, 313,
     3, 1, 0, 0, 0, 0, "0d0", -1, 0},
    {Food, 0x00000000, 0x330001C0, 2000, 0, 314, 3, 1, 0, 0, 0, 0,
     "0d0", -1, 0}, 
    {Food, 0x00000000, 0x22400060, 4000, 50, 315, 3, 1, 0, 0,
     0, 0, "0d0", -1, 0},
    {Food, 0x00000000, 0x00000000, 1500, 0, 306,
     252, 1, 0, 0, 0, 0, "0d0", -1, 0},
    {Food, 0x00000000, Nothing_flag, 3000, 2, 308, 5, 1, 0, 0, 0,
     0, "0d0", -1, 0}, 
    { Food, 0x00000000, Nothing_flag, 500, 1, 311, 10, 1,
     0, 0, 0, 0, "0d0", -1, 0},
    {Food, 0x00000000, 0x30400000,
     1000, 0, 317, 3, 1, 0, 0, 0, 0, "0d0", -1, 0}, 
    {Food, 0x00000000, 0x30C00080, 1000,
     0, 318, 3, 1, 0, 0, 0, 0, "0d0", -1, 0},
    {soft_armor, 0x00000000, Nothing_flag,
     0, 45, 11, 75, 1, -1, 0, 3, 0, "0d0", -1, 0},
    {soft_armor, 0x00000000, Nothing_flag,
     0, 45, 12, 300, 1, -1, 0, 9, 0, "0d0", -1, 0},
    {hard_armor, 0x00000000, Nothing_flag, 0,
     45, 14, 600, 1, -6, 0, 10, 0, "2d4", -1, 0},
    {soft_armor, 0x00000000, Nothing_flag, 0,
     900, 13, 160, 1, -1, 0, 17, 0, "1d2", -1, 0},
    {hard_armor, 0x00000000, Nothing_flag, 0,
     1800, 15, 240, 1, -1, 0, 24, 0, "1d4", -1, 0},
    {hard_armor, 0x00000000, Nothing_flag, 0,
     3600, 16, 400, 1, -1, 0, 32, 0, "2d4", -1, 0},
    {junk_food, 0x00000000, 0x00000000, 300, 1000, 270,
...
treasure_type store_door[MAX_STORES + MAX_UNNAMED + 5 + 1] = {
    {entrance_to_store, 0x00000000,
     0x00000000, 0, 0, 101, 0, 0, 0, 0, 0, 0, "0d0", 0, 0},
    {entrance_to_store, 0x00000000, 0x00000000, 0,
    ...
    {entrance_to_store, 0x00000000, 0x00000000, 0, 0,
     107, 0, 0, 0, 0, 0, 0, "0d0", 0, 0},
    {entrance_to_store, 0x00000000, 0x00000000,
...
treasure_type gold_list[MAX_GOLD] = {
    {valuable_metal, 0, 0, 0, 0, 2, 5, 420, 0, 0, 0, 0, " ", 2, 0},
    {valuable_metal, 0, 0, 0, 0, 1, 5, 2400, 0, 0, 0, 0, " ", 1, 0},
    {valuable_metal, 0, 0, 0, 0, 4, 5, 720, 0, 0, 0, 0, " ", 2, 0},
    {valuable_metal, 0, 0, 0, 0, 5, 5, 180, 0, 0, 0, 0, " ", 3, 0},
    {valuable_metal, 0, 0, 0, 0, 3, 5, 4800, 0, 0, 0, 0, " ", 1, 0},
    {valuable_metal, 0, 0, 0, 0, 6, 5, 1200, 0, 0, 0, 0, " ", 2, 0},
    {valuable_metal, 0, 0, 0, 0, 7, 5, 300, 0, 0, 0, 0, " ", 3, 0},
    {valuable_metal, 0, 0, 0, 0, 12, 5, 30, 0, 0, 0, 0, " ", 4, 0},
    {valuable_metal, 0, 0, 0, 0, 3, 5, 9000, 0, 0, 0, 0, " ", 1, 0},
    {valuable_metal, 0, 0, 0, 0, 6, 5, 2400, 0, 0, 0, 0, " ", 2, 0},
    {valuable_metal, 0, 0, 0, 0, 7, 5, 600, 0, 0, 0, 0, " ", 3, 0},
    {valuable_metal, 0, 0, 0, 0, 12, 5, 60, 0, 0, 0, 0, " ", 4, 0},
    {valuable_metal, 0, 0, 0, 0, 6, 5, 6000, 0, 0, 0, 0, " ", 2, 0},
    {valuable_metal, 0, 0, 0, 0, 7, 5, 1200, 0, 0, 0, 0, " ", 3, 0},
    {valuable_metal, 0, 0, 0, 0, 12, 5, 120, 0, 0, 0, 0, " ", 4, 0},
    {valuable_metal, 0, 0, 0, 0, 7, 5, 1500, 0, 0, 0, 0, " ", 3, 0},
    {valuable_metal, 0, 0, 0, 0, 18, 5, 150, 0, 0, 0, 0, " ", 4, 0},
    {valuable_metal, 0, 0, 0, 0, 20, 5, 50, 0, 0, 0, 0, " ", 5, 0},
    {valuable_metal, 0, 0, 0, 0, 16, 5, 3000, 0, 0, 0, 0, " ", 3, 0},
    {valuable_metal, 0, 0, 0, 0, 24, 5, 250, 0, 0, 0, 0, " ", 4, 0},
    {valuable_metal, 0, 0, 0, 0, 28, 5, 75, 0, 0, 0, 0, " ", 5, 0},
    {valuable_metal, 0, 0, 0, 0, 32, 5, 8, 0, 0, 0, 0, " ", 6, 0},
    {valuable_metal, 0, 0, 0, 0, 50, 5, 600, 0, 0, 0, 0, " ", 4, 0},
    {valuable_metal, 0, 0, 0, 0, 55, 5, 200, 0, 0, 0, 0, " ", 5, 0},
    {valuable_metal, 0, 0, 0, 0, 60, 5, 20, 0, 0, 0, 0, " ", 6, 0}
...
treasure_type door_open = {open_door, 0x00000000, 0x00000000, 0, 0, 1, 0, 0, 0, 0, 0,
    0, "1d1", 0, 0};
treasure_type door_closed = {closed_door, 0x00000000, 0x00000000, 0, 0, 19, 0, 0, 0, 0, 0, 0, "1d1", 0, 0};
treasure_type door_secret = {secret_door, 0x00000000, 0x00000000, 0, 0, 19, 0, 0, 0, 0, 0, 0, "1d1", 0, 0};
