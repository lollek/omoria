...
void sm__winnings()
{
	...
	if (winning == 0) {
		...
		if (winning > bet) {
			...
			case 1:
				msg_print(
				    "Hmmm...Maybe this system really works...");
				break;
			case 2:
			...
			case 3:
				msg_print(
				    "Coins begin to pour out of the machine.");
				break;
			case 4:
...
void sm__game_slots()
{
	...
	slotpos[3] = S_JACKPOT;
	sm__display_slots();
	prt("You are standing in front of a row of odd looking machines.", 1,
	    1);
	sm__slot_commands();
}
