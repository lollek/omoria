...
pub fn info(race: &Race) -> &'static str {
    match race {
...
pub fn search_mod(race: &Race) -> i8 {
    match race {
        Race::Human => 0,
        Race::HalfElf => 6,
        Race::Elf => 8,
...
pub fn melee_bonus(race: &Race) -> i8 {
    match race {
        Race::Human => 0,
        Race::HalfElf => 0,
        Race::Elf => -5,
...
pub fn ranged_bonus(race: &Race) -> i8 {
    match race {
        Race::Human => 0,
        Race::HalfElf => 5,
        Race::Elf => 15,
...
pub fn search_freq(race: &Race) -> i8 {
    match race {
        Race::Human => 0,
        Race::HalfElf => -1,
        Race::Elf => -1,
...
pub fn stealth_mod(race: &Race) -> i8 {
    match race {
        Race::Human => 0,
        Race::HalfElf => 1,
        Race::Elf => 1,
...
pub fn disarm_mod(race: &Race) -> i8 {
    match race {
        Race::Human => 0,
        Race::HalfElf => 2,
        Race::Elf => 5,
...
pub fn expfactor(race: &Race) -> f32 {
    match race {
        Race::Human => 1.00,
        Race::HalfElf => 1.10,
        Race::Elf => 1.20,
...
pub fn infravision(race: &Race) -> i8 {
    match race {
        Race::Human => 0,
        Race::HalfElf => 0,
        Race::Elf => 0,
...
pub fn swim_speed(race: &Race) -> i8 {
    match race {
        Race::Human => 0,
        Race::HalfElf => 1,
        Race::Elf => 2,
...
pub fn available_classes(race: &Race) -> Vec<Class> {
    match race {
        Race::Human => vec![
            Class::Fighter,
            Class::Wizard,
        ...
        Race::Gnome => vec![Class::Wizard, Class::Cleric, Class::Rogue, Class::Druid],
        Race::Dwarf => vec![
            Class::Fighter,
            Class::Cleric,
            Class::Druid,
        ...
        Race::HalfTroll => vec![Class::Fighter, Class::Cleric, Class::Barbarian],
        Race::Phraint => vec![
            Class::Fighter,
            Class::Wizard,
            Class::Rogue,
