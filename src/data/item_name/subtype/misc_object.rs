...
mod tests {
    ...
    fn test_misc_object_type_rat_skeleton() {
        let mut item =
            generate_item::generate(Box::new(MiscTemplate::RatSkeleton), 0, ItemQuality::Normal);
    ...
    fn test_misc_object_type_empty_bottle() {
        let mut item =
            generate_item::generate(Box::new(MiscTemplate::EmptyBottle), 0, ItemQuality::Normal);
    ...
    fn test_misc_object_type_shards_of_pottery() {
        let mut item =
            generate_item::generate(Box::new(MiscTemplate::PotteryShard), 0, ItemQuality::Normal);
    ...
    fn test_misc_object_type_elf_skeleton() {
        let mut item =
            generate_item::generate(Box::new(MiscTemplate::ElfSkeleton), 0, ItemQuality::Normal);
    ...
    fn test_misc_object_type_broken_set_of_teeth() {
        let mut item =
            generate_item::generate(Box::new(MiscTemplate::BrokenTeeth), 0, ItemQuality::Normal);
    ...
    fn test_misc_object_type_broken_stick() {
        let mut item =
            generate_item::generate(Box::new(MiscTemplate::BrokenStick), 0, ItemQuality::Normal);
