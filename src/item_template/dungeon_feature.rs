...
impl item_template::ItemTemplate for DungeonFeatureTemplate {
    fn name(&self) -> &str {
        match self {
            DungeonFeatureTemplate::Money => "<TODO>",
            DungeonFeatureTemplate::UnseenTrap => "<TODO>",
            DungeonFeatureTemplate::SeenTrap => "<TODO>",
            DungeonFeatureTemplate::Rubble => "<TODO>",
            DungeonFeatureTemplate::OpenDoor => "an open door",
            DungeonFeatureTemplate::ClosedDoor => "a closed door",
            DungeonFeatureTemplate::UpStaircase => "<TODO>",
            DungeonFeatureTemplate::DownStaircase => "<TODO>",
            DungeonFeatureTemplate::SecretDoor => "a secret door",
            DungeonFeatureTemplate::EntranceToStore => "<TODO>",
            DungeonFeatureTemplate::UpSteepStaircase => "<TODO>",
            DungeonFeatureTemplate::DownSteepStaircase => "<TODO>",
            DungeonFeatureTemplate::Whirlpool => "<TODO>",
        }
    }
