...
static void ht__house(long y, long x)
{
	...
	case 3:
		...
		default:
			if (characters_sex() != FEMALE) {
				...
				msg_print(
				    "The girls invite you to work with them.");
				brothel_game();
			}
		}
		break;
	...
	case 8:
		...
		case 2:
			msg_print(
			    "These are the quarters of a humble laborer.");
			break;
		case 3:
			msg_print(
			    " This is the home of several poor families.");
			break;
		}
	...
	case 9:
		...
		case 3:
			msg_print(
			    "This is the house of an accomplished craftsman.");
			break;
		}
