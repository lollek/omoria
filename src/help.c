    ...
    case 't':
      if (get_com("Enter character to be identified : ", &command)) {
        ...
        case 'A':
          ...
          break;
        case 'B':
          prt("B - First Moria National Bank.", 1, 1);
          break;
        case 'C':
          prt("C - Casino.", 1, 1);
          break;
    ...
    case 'd':
      if (get_com("Enter character to be identified : ", &command)) {
        ...
        case 'C':
          ...
          break;
        case 'D':
          prt("D - An Ancient Dragon (Beware).", 1, 1);
          break;
        case 'E':
          prt("E - Elemental.", 1, 1);
          break;
        case 'F':
          prt("F - Giant Fly or Faerie Dragon.", 1, 1);
          break;
        case 'G':
          prt("G - Ghost.", 1, 1);
          break;
        ...
        case 'R':
          ...
          break;
        case 'S':
          prt("S - Giant Scorpion/Sandgorgon.", 1, 1);
          break;
        case 'T':
          prt("T - Troll.", 1, 1);
          break;
    ...
    case 'w':
      if (get_com("Enter character to be identified : ", &command)) {
        ...
        case 'w':
          ...
          break;
        case 'C':
          prt("C  - Alligator or Crocodile.", 1, 1);
          break;
        case 'D':
          prt("D  - Dinosaur.", 1, 1);
          break;
